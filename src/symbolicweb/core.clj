      ...
      (let [[application viewport] (find-or-create-application-instance)]
        ...
        (binding [*application* application
          ...
          (if-let [sw-request-type (get (:query-params req) "_sw_request-type")]
            ...
            ;;(handle-normal-request-type) ;; It's a "normal" request.
            ;; TODO: In production, this should check host name instead of URL.
            (if (= (subs (:uri req) 0 (min 13 (count (:uri req))))
                   "/sw/alfatekst")
              (handler-alfatekst req)
